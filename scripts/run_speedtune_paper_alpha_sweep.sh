...
EPSILON_DECAY_STEPS="${EPSILON_DECAY_STEPS:-4000}"
...
for alpha in $ALPHAS; do
  ...
  overrides="--config.reward_mode paper_speedtuning --config.reward_alpha $alpha --config.reward_beta 2.0 --config.curriculum_enabled $CURRICULUM_ENABLED --config.epsilon_decay_steps $EPSILON_DECAY_STEPS"
